				...
				<div class="copyright-container">
					<?php
						...
						if ( !empty( $thbusiness_copyright_text ) ) {
							...
							printf( __( 'Derechos Reservados<a href="http://gcg.com.ve/" rel="designer"> Global Consulting Group</a>.', 'thbusiness' ), esc_url('http://gcg.com.ve/') );
					} ?>

				</div><!-- .copyright-container -->
				<div class="credit-container">
					<a href="<?php echo esc_url( __( '#', 'thbusiness' ) ); ?>"><?php printf( __( '2015-2016 %s', 'thbusiness' ), '' ); ?></a>
